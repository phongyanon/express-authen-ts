...
router.get("/UserRole/:id", async (req: Request, res: Response) => {
...
router.post("/userRole", async (req: Request, res: Response) => {
...
router.put("/userRole/:id", async (req: Request, res: Response) => {
...
router.delete("/userRole/:id", async (req: Request, res: Response) => {
  const id: string = (req.params.id).toString();
